...
function checkActionThenDispatch(store, action) {
  if (
...
function createTodo(todo) {
  ...
  itemText.addEventListener("click", () => {
    checkActionThenDispatch(store, removeTodoAC(todo.id));
  });

  itemStatus.addEventListener("click", () => {
    checkActionThenDispatch(store, toggleTodoAC(todo.id));
  });
...
function createGoal(goal) {
  ...
  goalText.addEventListener("click", () => {
    checkActionThenDispatch(store, removeGoalAC(goal.id));
  });
